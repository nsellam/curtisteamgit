...
/**
 * @fn callbacks_services_reset_time_to_current_update
 * @brief Reinit private variable indicating time remainng before the next motor's curremt data update period
 */
