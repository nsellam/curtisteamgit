...
/* Exported constants --------------------------------------------------------*/
/**
 * @brief Given pin was succesfully initialize as analogic input
*/
#define ADC_NO_ERROR                  0

/**
* @brief Given pin couldn't be initialize : port is unreachable
*/ 
#define ADC_ERROR_PORT               -1

/**
 * @brief Given pin couldn't be initialize : pin is unreachable
*/ 
